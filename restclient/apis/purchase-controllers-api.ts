...
export const PurchaseControllersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiPurchaseMeGet: async (status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        apiPurchaseUserUserIdGet: async (userId: string, status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new RequiredError('userId','Required parameter userId was null or undefined when calling apiPurchaseUserUserIdGet.');
            }
            const localVarPath = `/api/purchase/user/{userId}`
...
export const PurchaseControllersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPurchaseMeGet(status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<PurchaseEntity>>>> {
            const localVarAxiosArgs = await PurchaseControllersApiAxiosParamCreator(configuration).apiPurchaseMeGet(status, startTime, endTime, userId, start, ends, options);
         ...
         * @throws {RequiredError}
         */
        async apiPurchaseUserUserIdGet(userId: string, status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<PurchaseEntity>>>> {
            const localVarAxiosArgs = await PurchaseControllersApiAxiosParamCreator(configuration).apiPurchaseUserUserIdGet(userId, status, startTime, endTime, userId, start, ends, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PurchaseControllersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPurchaseMeGet(status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<PurchaseEntity>>> {
            return PurchaseControllersApiFp(configuration).apiPurchaseMeGet(status, startTime, endTime, userId, start, ends, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} productId 
         ...
         * @throws {RequiredError}
         */
        async apiPurchaseUserUserIdGet(userId: string, status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<PurchaseEntity>>> {
            return PurchaseControllersApiFp(configuration).apiPurchaseUserUserIdGet(userId, status, startTime, endTime, userId, start, ends, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PurchaseControllersApi extends BaseAPI {
     ...
     */
    public async apiPurchaseMeGet(status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<PurchaseEntity>>> {
        return PurchaseControllersApiFp(this.configuration).apiPurchaseMeGet(status, startTime, endTime, userId, start, ends, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} productId 
     ...
     * @memberof PurchaseControllersApi
     */
    public async apiPurchaseUserUserIdGet(userId: string, status?: string, startTime?: Date, endTime?: Date, userId?: string, start?: number, ends?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<PurchaseEntity>>> {
        return PurchaseControllersApiFp(this.configuration).apiPurchaseUserUserIdGet(userId, status, startTime, endTime, userId, start, ends, options).then((request) => request(this.axios, this.basePath));
    }
}
